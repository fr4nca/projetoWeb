...
export const MOCK: Itinerario[] = [
        ...
        atividades: [
          {
            ...
            dicas: [
              ...
              {
                conteudo:
                  "Chegar cedo pois a praia tende a ficar lotada rápido",
                usuario: this.usuario
              },
              {
        ...
        atividades: [
          ...
          },
          {
            ...
            dicas: [
              ...
              {
                conteudo: "Levar óculos de mergulho para observar os peixes",
                usuario: this.usuario
              },
              {
                conteudo: "Levar toalha",
          ...
          },
          {
            ...
            dicas: [
              {
                conteudo:
                  "Dependendo da época do ano o pôr do sol pode acontecer mais cedo ou mais tarde deste horário.",
                usuario: this.usuario
              },
              {
                conteudo: "Local venta bastante",
                usuario: this.usuario
              }
            ]
          },
        ...
        atividades: [
          ...
          },
          {
            ...
            dicas: [
              {
                conteudo:
                  "Praça bem movimentada à noite, bom local para comprar artesanatos",
                usuario: this.usuario
              },
              {
                conteudo:
                  "Possui ótimos restaurantes, mas com preço um pouco salgado",
                usuario: this.usuario
              }
            ]
          }
    ...
    dias: [
      {
        ...
        atividades: [
          {
            conteudo:
              "Comece já tirando fotos pois a vista é linda na entrada.",
            hora: "8h30",
            done: false,
            dicas: [
              {
              ...
              {
                conteudo:
                  "Chegue bem cedo, é bem dificil tirar fotos quando a entrada está lotada",
                usuario: this.usuario
              }
            ]
          },
          {
            conteudo:
              " Comece de forma radical indo na Roller Coaster Aerosmith! ",
            hora: "9h00",
            done: false,
            dicas: [
              {
              ...
              {
                conteudo:
                  "A preferencia é ir de manha pois voce não vai estar muito cansado e a fila da atração é menor!",
                usuario: this.usuario
              },
              {
                conteudo: "Chegar cedo, a fila fica grande",
          ...
          {
            conteudo:
              "Entre em uma jornada na The Twilight Tower of Terror - Outra atração radical! ",
            hora: "10h00",
            done: false,
            dicas: [
              {
          ...
          },
          {
            ...
            dicas: [
              {
                conteudo:
                  "Aproveite dos restaurantes, pois há várias variedades",
                usuario: this.usuario
              },
              {
                conteudo:
                  "Não coma muito, mas não coma pouco. O dia é cheio e cansativo e você precisa estar 100%",
                usuario: this.usuario
              }
            ]
          },
          {
            conteudo:
              "Aproveite teatros, espetáculos e tire fotos depois do almoço. ",
            hora: "14h30",
            done: false,
            dicas: [
              {
          ...
          {
            conteudo:
              "Visite a atração Toy Story Mania - Atração de tiro ao alvo bem divertido. ",
            hora: "16h00",
            done: false,
            dicas: [
              {
              ...
              {
                conteudo:
                  "Dê o melhor de si, o jogo é de competição entre outros jogadores",
                usuario: this.usuario
              }
            ]
          },
          ...
          {
            conteudo:
              "Por fim não perca o incrivel Fantasmic - Show de fogos de artificios que te deixará de boca aberta ",
            hora: "20h00",
            done: false,
            dicas: [
              {
                conteudo:
                  "Chegue cedo para conseguir um ótimo lugar na arquibancada",
                usuario: this.usuario
              },
              {
...

  {
        ...
        atividades: [
          {
            ...
            dicas: [
              ...
              {
                conteudo:
                  "Coma os famosos waffles americanos com um clocolate quente",
                usuario: this.usuario
              }
            ]
          },
          {
            conteudo:
              "Veja a cidade de Nova York acordando no One World Obervatory",
            hora: "10h00",
            done: false,
            dicas: [
              {
          ...
          },
          {
            ...
            dicas: [
              ...
              {
                conteudo:
                  "Não coma muito pois voce vai andar praticamente o dia todo",
                usuario: this.usuario
              },
              {
          ...
          },
          {
            ...
            dicas: [
              ...
              {
                conteudo:
                  "Visite os pontos turisticos do local como estátuas famosas.",
                usuario: this.usuario
              }
            ]
          },
          {
            ...
            dicas: [
              {
                conteudo:
                  "Leve já o guia do outlet para ser mais eficientenas compras",
                usuario: this.usuario
              },
              {
          ...
          {
            conteudo:
              "Visite Empire State Building e veja a cidade mais movimentada do mundo de noiste",
            hora: "20h00",
            done: false,
            dicas: [
              {
              ...
              {
                conteudo:
                  "De preferência venha de noite por conta das luzes da cidade",
                usuario: this.usuario
              }
            ]
          }
    ...
    descricao: "Itinerário voltado para e orientar melho em Nova York",
        ...
        atividades: [
          {
            ...
            dicas: [
              {
                conteudo:
                  "Procure não se atrasar, a partir das 10horas fica lotado",
                usuario: this.usuario
              },
              {
                conteudo: "Levar dinheiro vivo",
